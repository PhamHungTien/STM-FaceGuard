...
\contentsline {lstlisting}{\numberline {B.4}{\ignorespaces Callback ngắt Idle Line - xử lý thông điệp hoàn chỉnh}}{32}{lstlisting.B.4}%
\contentsline {lstlisting}{\numberline {B.5}{\ignorespaces Main loop FSM xử lý sự kiện không chặn}}{32}{lstlisting.B.5}%
\contentsline {lstlisting}{\numberline {B.6}{\ignorespaces Independent Watchdog (IWDG) STM32F411 - ~5s timeout}}{33}{lstlisting.B.6}%
\contentsline {lstlisting}{\numberline {B.7}{\ignorespaces Task Watchdog (Task WDT) ESP32-S3 - 30s timeout}}{33}{lstlisting.B.7}%
