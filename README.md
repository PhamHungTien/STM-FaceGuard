...
> - Firmware hiện bật đèn trắng **GPIO47** ngắn khi thấy khuôn mặt; kênh RGB/NeoPixel **GPIO48** sáng xanh khi camera sẵn sàng và sáng trắng tối đa khi detect được khuôn mặt
...
- Firmware hiện dùng preset low-light rõ ràng hơn cho OV3660: tăng `brightness`, nâng `ae_level`, mở `gainceiling` cao hơn và tăng `denoise` để ảnh indoor sáng hơn.
- Firmware hiện bật đèn trắng chính trên `GPIO47` trong khoảng ngắn mỗi khi thấy khuôn mặt; RGB `GPIO48` sáng xanh khi camera ready và sáng trắng tối đa khi detect mặt. Nếu board thực tế khác biến thể này, sửa các hằng `FACE_LIGHT_*` trong [STM-FaceGuard.ino](/Users/phamhungtien/Documents/STM-FaceGuard/ESP32-S3/STM-FaceGuard/STM-FaceGuard.ino#L94).
- Khi mở trang preview, firmware sẽ bật đèn trợ sáng ngắn ngay trước lúc chụp `/capture`, nên ảnh preview sáng hơn rõ rệt trong phòng tối.
