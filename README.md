...
| GPIO48 | Flash LED trắng | Tự bật ngắn khi phát hiện khuôn mặt |
...
- Firmware cũng bật `flash LED` trắng trên `GPIO48` trong khoảng ngắn mỗi khi thấy khuôn mặt để tăng sáng, theo đúng pinout board bạn đã gửi. Nếu board thực tế khác biến thể này, sửa `FACE_LIGHT_GPIO` hoặc đặt `FACE_LIGHT_ENABLE = 0` trong [STM-FaceGuard.ino](/Users/phamhungtien/Documents/STM-FaceGuard/STM-FaceGuard/ESP32-S3/STM-FaceGuard/STM-FaceGuard.ino#L76).
